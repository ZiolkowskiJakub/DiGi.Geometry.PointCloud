...
namespace DiGi.Geometry.PointCloud.Planar
{
    ...
    {
        /// <summary>
        /// Builds a <see cref="Geometry.Planar.Classes.Triangle2D"/> from the points of a cloud nearest to a query point.
        /// </summary>
        ...
        /// <returns>A new <see cref="Geometry.Planar.Classes.Triangle2D"/>, or <see langword="null"/> when the cloud holds too few points or offers no non-degenerate triple.</returns>
        ...
        /// <summary>
        /// Builds a <see cref="Geometry.Planar.Classes.Triangle2D"/> from the points of a cloud nearest to a query position.
