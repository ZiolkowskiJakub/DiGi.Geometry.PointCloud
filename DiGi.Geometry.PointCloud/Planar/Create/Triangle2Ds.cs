...
namespace DiGi.Geometry.PointCloud.Planar
{
    ...
    {
        /// <summary>
        /// Builds one <see cref="Geometry.Planar.Classes.Triangle2D"/> per point of a query cloud from the points of a source cloud nearest to it.
        ...
        /// <returns>A <see cref="List{T}"/> holding one <see cref="Geometry.Planar.Classes.Triangle2D"/> per query point, or <see langword="null"/> when either cloud is empty.</returns>
