...
{
    /// <summary>
    /// Represents a zero-copy, read-only window onto the coordinate arrays of a <see cref="PointCloud2D"/>.
    ...
    public readonly ref struct PointCloud2DView
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PointCloud2DView"/> struct.
        /// <para>When the two spans are not of equal length the view is empty, so a mismatched construction cannot produce out-of-range reads.</para>
        /// </summary>
        /// <param name="x">The X coordinates.</param>
        /// <param name="y">The Y coordinates.</param>
        public PointCloud2DView(ReadOnlySpan<double> x, ReadOnlySpan<double> y)
        {
        ...
        /// <returns>A <see cref="PointCloud2D.Point"/> holding the coordinates at that index.</returns>
        public PointCloud2D.Point this[int index]
        {
            get
            {
                return new PointCloud2D.Point(x[index], y[index]);
            }
        }
        ...
        public PointCloud2DView Slice(int startIndex, int count)
        {
            ...
            return new PointCloud2DView(x.Slice(startIndex, count), y.Slice(startIndex, count));
        }
        ...
        /// <summary>
        /// Walks a <see cref="PointCloud2DView"/> one point at a time without allocating.
        /// <para>This one must be a ref struct, because it holds the spans of the view it walks.</para>
        /// </summary>
        public ref struct Enumerator
        {
            private readonly PointCloud2DView pointCloud2DView;
            private int index;

            /// <summary>
            /// Initializes a new instance of the <see cref="Enumerator"/> struct.
            /// </summary>
            /// <param name="pointCloud2DView">The view to walk.</param>
            public Enumerator(PointCloud2DView pointCloud2DView)
            {
                this.pointCloud2DView = pointCloud2DView;
                index = -1;
            }
            ...
            public bool MoveNext()
            {
                ...
                return index < pointCloud2DView.Count;
            }
        }
    }
}
